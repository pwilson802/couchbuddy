export default async function handler(req, res) {
  ...
  let url = `https://api.themoviedb.org/3/tv/${id}?api_key=${TMB_KEY}&language=en-US`;
  const watchUrl = `https://api.themoviedb.org/3/tv/${id}/watch/providers?api_key=${TMB_KEY}`;
  let retry = 0;
  while (true) {
