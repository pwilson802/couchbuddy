...
function DateRangeDecades({
  ...
  return (
    <div css={styles.wrapper}>
      <div
        onClick={() => updateRange(1950)}
        css={[styles.dateBox, styles.firstBox]}
      >
        50s
      </div>
      <div onClick={() => updateRange(1960)} css={styles.dateBox}>
        60s
      </div>
      <div onClick={() => updateRange(1970)} css={styles.dateBox}>
        70s
      </div>
      <div onClick={() => updateRange(1980)} css={styles.dateBox}>
        80s
      </div>
      <div onClick={() => updateRange(1990)} css={styles.dateBox}>
        90s
      </div>
      <div onClick={() => updateRange(2000)} css={styles.dateBox}>
        00s
      </div>
      <div onClick={() => updateRange(2010)} css={styles.dateBox}>
        10s
      </div>
      <div onClick={() => updateRange(2020)} css={styles.dateBox}>
        20s
      </div>
    </div>
  );
